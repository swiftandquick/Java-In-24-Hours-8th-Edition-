package com.java24hours.hour20.p5;
...
public class Console {
	...
	public static void main(String[] args) {
		...
		/** Since readLine() is a static method, I can invoke the 
		 * method by calling the class name Console.  Console is 
		 * not a keyword in Java and it does not invoke anything in
		 * Eclipse's console, it's just a class name.  */
		// Console.readLine();
		
		/** I print out the String that is return from the readLine() 
		 * method, it should contain exactly the same characters that 
		 * I typed into Eclipse's console.  */
