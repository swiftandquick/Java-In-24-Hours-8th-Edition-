package com.java24hours.hour20.p9;
...
public class PropertiesDemo {
	...
	File configFile = new File("src/com/java24hours/hour20/p9/config.dat");

	PropertiesDemo() {
		try {
			FileInputStream readFile =  new FileInputStream(configFile);

			/** The Properties class class is able to separate properties with 
			 ...
			 * my newly created property firstCommand is on the list.  */
