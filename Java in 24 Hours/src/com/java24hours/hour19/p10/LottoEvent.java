...
public class LottoEvent implements ActionListener, ItemListener, Runnable {
	...
	public void itemStateChanged(ItemEvent event) {
		...
		if (item == gui.quickpick) {
			 ...
			 * JTetField. In quickpick, the six JTextField retrieve six respective
			...
			for (int i = 0; i < 6; i++) {
				 ...
				 * same numbers in JTextField, because lottery numbers can't be the same. For
				 * more information, check out the numberGone() method. */
				do {
		 ...
		 * ButtonGroup, I can only choose one or the other. If quickpick is picked, 
	...
	/** It's used to for the for loop inside itemStateChanged. The do while loop will
