package com.java24hours.hour22.p2;

import javax.swing.*;
import java.awt.*; // This package includes Graphics object

@SuppressWarnings("serial")
public class FontsDemo2 extends JPanel {	
	...
	public void paintComponent(Graphics comp) {
		...
		/** Writes the String on the frame, place it 15 pixels to the right, and 50 pixels downward.  */
	...
	public static void main(String args[]) {
		...
		FontsDemo2 panel = new FontsDemo2();
